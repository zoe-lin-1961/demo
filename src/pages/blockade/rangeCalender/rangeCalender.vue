    ...
    <div>
      <a-input-group compact>
       <a-range-picker 
        ...
        />
          <a-button :size="size" @click="theDayBefore">前一天</a-button>
          <a-button :size="size" @click="theDayAfter">後一天</a-button>
      </a-input-group>
      </div>
...
export default {
  ...
  methods:{
    ...
    getSize(){
      this.thesize=this.size
      console.log(this.size,"3333看看有没有...")
    }
