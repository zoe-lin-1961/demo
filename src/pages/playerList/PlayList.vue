<template>
<div>
  <div style="padding:12px;"><h2><a-icon type="user"/>&nbsp;&nbsp;玩家列表</h2></div>
<div class="theBox" v-if="this.page=='playList'">
  ...
  <div class="centerDiv" >
    ...
    <a-button type="primary"  style="margin-left:8px" @click="addplayBtn">新增玩家</a-button>
    </h3>
    </div>
    ...
    <div class="bottomBox" >
       <h4>玩家數: 4 </h4>
       <a-table ref="table" class="ant-table-striped" :columns="columns" :data-source="data" :pagination="pagination" 
        :scroll="{ x: '100%'}"
         bordered >    
      ...
      <!-- 进阶搜寻的弹窗 开始-->
      <a-modal title="進階搜尋" :visible="visible" :maskStyle="maskStyle" @ok="handleOk" @cancel="handleCancel" :centered="true" :maskClosable="false">
         <div>
           ...
           <div style="margin-bottom:8px">
            <a-input-group compact><a-select default-value="886" style="width: 30%" size="small" >
                ...
                </a-select><a-input :value="phone" style="width: 70%" size="small" />
            </a-input-group>
           </div>
           <div style="position:relative;float:left;width:48%">
           <h4 style="margin-bottom:2px">身分證字號 / 證號</h4>
           <div style="margin-bottom:8px"><a-input style="width: 100%" size="small" ><a-icon slot="prefix" type="idcard" /></a-input></div>
           </div>
           <div style="position:relative;float:left;width:48%;margin-left:2%">
           <h4 style="margin-bottom:2px">姓名</h4>
           <div style="margin-bottom:8px"><a-input style="width: 100%" size="small" ><a-icon slot="prefix" type="idcard" /></a-input></div>
           </div>
           <h4 style="margin-bottom:2px">選擇帳戶類型</h4>
           <div style="margin-bottom:8px">
              <a-radio-group  v-model="conterTypeValue"   ><a-radio :value="1" @change="onChangeConterTypeValue">一般</a-radio><a-radio :value="2" @change="onChangeConterTypeValue">虛擬貨幣錢包</a-radio></a-radio-group>
           </div>
           <h4 style="margin-bottom:2px">錢包餘額</h4>
           <div style="margin-bottom:8px"><a-input style="width:calc(50% - 15px)" placeholder="最低" size="small"/> 到 <a-input style="width:calc(50% - 15px)" placeholder="最高" size="small"/></div>
            <h4 style="margin-bottom:2px">紅利餘額</h4>
           <div style="margin-bottom:8px"><a-input style="width:calc(50% - 15px)" placeholder="最低" size="small"/> 到 <a-input style="width:calc(50% - 15px)" placeholder="最高" size="small"/></div>
           <h4 style="margin-bottom:2px">金流分數</h4>
           <div style="margin-bottom:8px"><a-input style="width:calc(50% - 15px)" placeholder="最低" size="small"/> 到 <a-input style="width:calc(50% - 15px)" placeholder="最高" size="small"/></div>
          ...
          <div style="margin-bottom:8px"><rangeCalender/></div>
           ...
           <h4 style="margin-bottom:2px">處理時間</h4>
           <div style="margin-bottom:8px"><rangeCalender/></div>
           ...
           <h4 style="margin-bottom:2px">搜尋結果排序</h4>
            <div style="margin-bottom:8px">
              ...
              <a-select default-value="id" style="width:120px;" size="small">
                ...
                <a-select-option value="reman" >錢包餘額</a-select-option>
                <a-select-option value="moneyFlu" >金流分數</a-select-option>
...
const columns = [
  ...
  {title: '公司輸贏',key: 'companyOdds',dataIndex: 'companyOdds',align:'center',width:'100px'},
  ...
  {title: '建立時間',key: 'buildTime',dataIndex: 'buildTime',align:'center',width:'120px'},
  ...
  {title: '交易歷史',key: 'tradeHis',dataIndex: 'tradeHis',scopedSlots: { customRender: 'tradeHis' },align:'center',width:'120px'},
];
const data=[
  {key: '1',merberNumber: ['AA1234'],merberNumberCopy:'copy',status: '正常',remain: 15000,companyOdds:150000,phoneCode:'0912345678'
  ,samIpCount:7,buildTime:'2021/04/03 23:11:54',lastLogin:['2021/04/03 23:11:54','35.232.180.179'],notice:['notice'],tradeHis:['tradeHis']},
  {key: '2',merberNumber: ['AA1235'],merberNumberCopy:'copy',status: '正常',remain: 15000,companyOdds:150000,phoneCode:'0912345678'
  ,samIpCount:7,buildTime:'2021/04/03 23:11:54',lastLogin:['2021/04/03 23:11:54','163.28.83.144'],notice:['notice'],tradeHis:['tradeHis']},
  {key: '3',merberNumber: ['AA1236'],merberNumberCopy:'copy',status: '正常',remain: 15000,companyOdds:150000,phoneCode:'0912345678'
  ,samIpCount:7,buildTime:'2021/04/03 23:11:54',lastLogin:['2021/04/03 23:11:54','220.128.187.2'],notice:['notice'],tradeHis:['tradeHis']},
  {key: '4',merberNumber: ['AA1237'],merberNumberCopy:'copy',status: '正常',remain: 15000,companyOdds:150000,phoneCode:'0912345678'
  ,samIpCount:7,buildTime:'2021/04/03 23:11:54',lastLogin:['2021/04/03 23:11:54','35.232.180.179'],notice:['notice'],tradeHis:['tradeHis']},
]
export default {
  components:{rangeCalender,addplayer,history},
  created(){
