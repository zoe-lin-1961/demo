<template>
  <div>
    <div class="theBox">
      <div class="centerDiv" >
        <h3>交易歷史 <a-button  icon="left-circle" @click="lastPage" size="small" style="margin-left:5px">回上一頁</a-button></h3>
         <div class="topBox">
                <h3>
                 <a-input placeholder="編號 (訂單)" style="width:25%"/>   
        ...
        <div class="bottomBox" >
           ...
           <div style="position:relative;float:left;width:100%;">
           <h4 style="margin-bottom:2px">系統電子編號</h4>
           <div style="margin-bottom:8px"><a-input style="width: 48%" size="small" ><a-icon slot="prefix" type="idcard" /></a-input></div>
           </div>
...
const columns = [
  ...
  {title: '會員',dataIndex: 'menber',key: 'menber',align:'center',width:'100px'},
  {title: '時間',dataIndex: 'time',key: 'time',align:'center',width:'120px'},
  {title: '動作',dataIndex: 'behaver',key: 'behaver',align:'center',width:'120px'},
...
const data=[
  ...
  {key:'2',number:'6775905',status:'1',menber:'AA1234',time:'2021/04/23 00:59:03',behaver:'儲值',cashflow:'系統 > 會員帳戶',
  beforetrade:'0.00',trademount:'1,000.00',actualamount:'1,000.00',balance:'1,000.00',theway:['海皇','超商繳費','00000000001106007','N/A','711超商繳費','AB2JB48NAG0133','472','儲值']},
  {key:'3',number:'6775906',status:'1',menber:'AA1234',time:'2021/04/23 00:59:03',behaver:'儲值',cashflow:'系統 > 會員帳戶',
  beforetrade:'0.00',trademount:'1,000.00',actualamount:'1,000.00',balance:'1,000.00',theway:['海皇','超商繳費','00000000001106007','N/A','711超商繳費','AB2JB48NAG0133','472','儲值']},
  {key:'4',number:'6775907',status:'1',menber:'AA1234',time:'2021/04/23 00:59:03',behaver:'儲值',cashflow:'系統 > 會員帳戶',
  beforetrade:'0.00',trademount:'1,000.00',actualamount:'1,000.00',balance:'1,000.00',theway:['海皇','超商繳費','00000000001106007','N/A','711超商繳費','AB2JB48NAG0133','472','儲值']},
...
const kindData=[
    {title:'全選',value: '3',key: '3',children: [
  
      {
        ...
        key: '4',
        children: [
            {title: '儲值',value: '4-0-1',key: '4-0-1'},{title: '優惠',value: '4-0-2',key: '4-0-2'},
            {title: '遊戲點數異常補點',value: '4-0-3',key: '4-0-3'},{title: '手動上分',value: '4-0-4',key: '4-0-4'},
        ]
      },
       {
        title: '扣點類型',
        ...
        key: '5',
        children: [
            {title: '轉移',value: '5-0-1',key: '5-0-1'},
            {title: '手動加點',value: '5-0-2',key: '5-0-2'},
            {title: '優惠扣回',value: '5-0-3',key: '5-0-3'},
            {title: '遊戲點數異常扣點',value: '5-0-4',key: '5-0-4'}
            
        ]
      }
    ]}
    // {title:'全選加點類型',value: '4',key: '4'},
    // {title:'全選扣點類型',value: '5',key: '5'},
]
export default {
  ...
  methods:{
      ...
      lastPage(){
          this.$emit('chagePageName','playList')
      },
      showStatistics(){
      ...
      this.data.map((d)=>{
        list.push(d)
            ...
            require.ensure([], () => {
                ...
                export_json_to_excel(tHeader, data, "玩家列表-交易歷史 列表");
            });
      },
