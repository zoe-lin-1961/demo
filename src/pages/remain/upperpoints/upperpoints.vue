<template>
 <!-- <div class="theBox"> -->
 <div class="theBox">  
 <div v-if="page=='upperpoints'" class="centerDiv">
   <h3>手動上分  <a-button  icon="left-circle" @click="lastPage" size="small" style="margin-left:5px">回上一頁</a-button></h3>
   ...
   <div  class="centerDiv">
      ...
      <a-input  class="mB"  placeholder="帳號" /> 

      <h3>交易金額</h3>
      <!-- <a-input v-model:value="value" placeholder="Basic usage" /> -->
      <a-input  class="mB"  placeholder="交易金額" /> 

       <h3>備註</h3>
      <!-- <a-input v-model:value="value" placeholder="Basic usage" /> -->
      <a-input  class="mB"  placeholder="備註" /> 
    
      
     <div style="margin-top:30px;margin-bottom:15px;text-align:center">
        <a-button type="primary" @click="setOdds">確定</a-button>
...
//   components:{Odds},
  ...
  methods:{
      ...
      lastPage(){
        this.$emit('chagePageName', this.backFather)
      },
    //   fatherPage(pageName){
    //     this.page=pageName
    //   }
